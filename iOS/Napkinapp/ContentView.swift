...
struct ContentView: View {
    ...
    @State private var editingEntry: NapkinappEntry?
    ...
    @ViewBuilder
    private func row(for entry: NapkinappEntry) -> some View {
        HStack {
...
struct EntryFormView: View {
    ...
    let entry: NapkinappEntry?
    let onSave: (NapkinappEntry) -> Void
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        ...
                        var e = entry ?? NapkinappEntry(clientName: name, amount: amount, note: note, date: date)
                        e.clientName = name
                        e.amount = amount
                        e.note = note
                        e.date = date
