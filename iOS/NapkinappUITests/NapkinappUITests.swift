...
final class NapkinappUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Napkin Pro"].waitForExistence(timeout: 2))
    }
